  ...
  return (
    <section ref={sectionRef} style={{ padding: '128px 0' }}>
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 24px' }}>
        ...
        {/* header */}
        <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'flex-end', justifyContent: 'space-between', gap: 32, marginBottom: 64 }}>
          <div>
            <motion.div initial={{ opacity: 0, x: -20 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.6 }}
              ...
              <span style={{ fontFamily: 'Syne', fontSize: 10, letterSpacing: '0.32em', textTransform: 'uppercase', color: '#C8A96E' }}>Before / After</span>
            </motion.div>
            <motion.h2 initial={{ opacity: 0, y: 32 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.9, delay: 0.1, ease: [0.16, 1, 0.3, 1] }}
              ...
              The<br /><em style={{ color: '#C8A96E' }}>Difference</em>
            </motion.h2>
          </div>
          <motion.p initial={{ opacity: 0 }} animate={inView ? { opacity: 1 } : {}} transition={{ duration: 0.8, delay: 0.3 }}
            ...
            Drag the handle to reveal the transformation. This is what intentional editing looks like.
          </motion.p>
        </div>
        ...
        <motion.p
          ...
          style={{ marginTop: 16, textAlign: 'center', fontFamily: 'Syne', fontSize: 10, letterSpacing: '0.22em', textTransform: 'uppercase', color: '#3A3530' }}
        >
